...
//用户配置区			  
//SDMMC时钟计算公式:SDMMC_CK时钟=SDMMCCLK/[clkdiv+2];其中,SDMMCCLK固定为48Mhz
//使用DMA模式的时候,传输速率可以到48Mhz(bypass on时),不过如果你的卡不是高速
//卡,可能也会出错,出错就请降低时钟
#define SDMMC_INIT_CLK_DIV        0x76 		//SDMMC初始化频率，最大400Kh  
#define SDMMC_TRANSFER_CLK_DIV    0x00		//SDMMC传输频率,该值太小可能会导致读写文件出错 
										 

//////////////////////////////////////////////////////////////////////////////////////////////////// 
//SDMMC工作模式定义,通过SD_SetDeviceMode函数设置.
#define SD_POLLING_MODE    	0  	//查询模式,该模式下,如果读写有问题,建议增大SDMMC_TRANSFER_CLK_DIV的设置.
#define SD_DMA_MODE    		1	//DMA模式,该模式下,如果读写有问题,建议增大SDMMC_TRANSFER_CLK_DIV的设置.   
...
//SDMMC相关参数定义
#define NULL 0
#define SDMMC_STATIC_FLAGS				((u32)0x000005FF)
